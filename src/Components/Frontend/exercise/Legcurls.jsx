import legraisesImage from '../../../assets/legcurls.jpg'
...
//from hwre updation happened
  ...
  const startCamera = () => {
    ...
    axios.get('http://localhost:8081/Legcurl')
      .then(response => {
  ...
  const closeCamera = () => {
    ...
    axios.get('http://localhost:8081/stop_Legcurl')
      .then(response => {
        console.log(response.data.message);
