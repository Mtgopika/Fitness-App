import legraiseImage from '../../../assets/legraises.jpg'
...
//from hwre updation happened
  ...
  const startCamera = () => {
    ...
    axios.get('http://localhost:8081/Legraises')
      .then(response => {
  ...
  const closeCamera = () => {
    ...
    axios.get('http://localhost:8081/stop_Legraises')
      .then(response => {
        console.log(response.data.message);
